<svg style="display: none;">
  ...
  <symbol id="icon-arrow-left" viewBox="0 0 35 60">
    <path d="M8.1 30.003L35 55.979 31.07 60 0 30.003 31.07 0 35 4.02 8.1 30.003z"/>
  </symbol>
  <symbol id="icon-arrow-right" viewBox="0 0 35 60">
    <path d="M0 4.02L3.93 0 35 30.003 3.93 60 0 55.979l26.9-25.977L0 4.02z"/>
  </symbol>
</svg>